...
! function(a, b) { "use strict";
    ...
    function d(d, g) {
        function h() {
            if (y) { r = b.createElement("canvas"), r.className = "pg-canvas", r.style.display = "block", d.insertBefore(r, d.firstChild), s = r.getContext("2d"), i();
        ...
        function j() {
            if (y) { u = a.innerWidth, v = a.innerHeight, s.clearRect(0, 0, r.width, r.height);
        ...
        function k() { i();
            ...
            if (e > z.length)
                for (; e > z.length;) {
                    var f = new n;
                    z.push(f) } else e < z.length && z.splice(e);
        ...
        return g = c({}, a[e].defaults, g), n.prototype.draw = function() { s.beginPath(), s.arc(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY, g.particleRadius / 2, 0, 2 * Math.PI, !0), s.closePath(), s.fill(), s.beginPath();
            ...
            s.stroke(), s.closePath() }, n.prototype.updatePosition = function() {
            if (g.parallax) {
                if (D && !C) {
                    var a = (u - 0) / 60;
                    w = (E - -30) * a + 0;
...
jQuery(document).ready(function($){
    ...
    $(document).ready(function() {
      ...
      $('#particle-header').logosDistort(options);
...
*/  
jQuery(document).ready(function() {
    jQuery('.portfolio-list').addClass("hidden").viewportChecker({
        classToAdd: 'visible wow fadeInbottom',
        offset: 100
       });
});
